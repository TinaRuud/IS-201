...
@WebServlet(name = "GetUserServletOwn", value = "/GetUserServletOwn")
public class GetUserServletOwn extends HttpServlet {
    ...
    private UserModel getUser(String uname, PrintWriter out) throws SQLException {
        ...
        String query3 = "insert into user (User_firstName) values (?);";
